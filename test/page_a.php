...
function ajoute_input($nom, $checkbox_cochée) {
  ...
  $echo .= "<input type='checkbox' id = 'test' name='test' value='true' checked='true' onclick='" . $checkbox_cochée . "'>";
  ...
  $tableau_contraintes = array();
  foreach ($tables as $nom_table => $table) {
    
    $contrainte = "";
    foreach ($table as $colonne) {
      $contrainte .= ajoute_input($colonne, "checkbox_cochée()");
    }

    $tableau_contraintes[$nom_table] = $contrainte;
  }*/
